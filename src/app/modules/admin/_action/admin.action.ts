...
export const editCourses = createAction(EDIT_COURSES_ACTION, props<{payload:CoursesUpdate}>());
export const editCoursesSuccess = createAction(EDIT_COURSES_SUCCESS, props<{payload:CoursesUpdate}>())
